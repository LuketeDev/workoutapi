...
Revision ID: d581fb20e3cd
Revises: 
Create Date: 2024-10-24 15:19:45.885575
...
def upgrade() -> None:
    ...
    sa.Column('centro_treino_id', sa.Integer(), nullable=False),
    sa.Column('id', sa.UUID(), nullable=False),
    sa.ForeignKeyConstraint(['categoria_id'], ['categorias.pk_id'], ),
    sa.ForeignKeyConstraint(['centro_treino_id'], ['centro_treinamento.pk_id'], ),
    sa.PrimaryKeyConstraint('pk_id'),
